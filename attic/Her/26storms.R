...
DynamicFilterModuleServer <- function(id, data, plot_width = 800, plot_height = 200) {
...
server <- function(input, output, session) {
  # Provide a data frame to the module (e.g., storms from dplyr)
  DynamicFilterModuleServer("filterModule", storms)
}
